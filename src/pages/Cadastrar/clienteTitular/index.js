...
function CadastrarClientes() {
  ...
  return (
    <section>
      ...
      <main>
        <div className='text'>
          <h1 className='margin-titulo'><strong>Cadastrar Cliente</strong></h1>
        </div>
        <div className="forms">
          <form onSubmit={handleSubmit}>
            <div className="field">
              <label>Nome Completo:</label>
              <input placeholder='Nome completo do cliente' type="text" value={nome} onChange={(e) => setNome(e.target.value)} required/>
            </div>
            ...
            <div className="campo-duplo">
              <div className="field esquerda">
                  <label>CPF:</label>
                  <input type="text" placeholder='Preencha o CPF' value={cpf} onChange={(e) => setCpf(e.target.value)} required/>
              </div>
              <div className="field direita">
                  <label>Passaporte:</label>
                  <input type="text" placeholder='Preencha o número do passaporte' value={passaporte} onChange={(e) => setPassaporte(e.target.value)} required/>
              </div>
            </div>
            ...
            <div className="campo-duplo">
              <div className="field esquerda">
                ...
                <input placeholder='Nome do locadouro' type="text" value={rua} onChange={(e) => setRua(e.target.value)} required/>
              </div>
              <div className="field direita">
                <label>Bairro:</label>
                <input placeholder='Nome do bairro' type="text" value={bairro} onChange={(e) => setBairro(e.target.value)} required/>
              </div>
            </div>
            <div className="campo-duplo">
              <div className="field esquerda">
                <label>Cidade:</label>
                <input placeholder='Nome da cidade' type="text" value={cidade} onChange={(e) => setCidade(e.target.value)} required/>
              </div>
              <div className="field direita">
                <label>Estado:</label>
                <input placeholder='Nome do estado' type="text" value={estado} onChange={(e) => setEstado(e.target.value)} required/>
              </div>
            </div>
            <div className="field">
                <label>País:</label>
            ...
            <div className="btns">
              <a  id='add' type='button' onClick={() => addDependentes()}>Adicionar dependentes</a>
            </div>

            <div className="btns">
              <Button className="add add-yellow" variant="outline-dark" type='submit'>Cadastrar</Button>{' '}
            </div>
          </form>
        </div>
      </main>
